...
class GrafoYessica:
    ...
    def nodoscrear(self, v, x, y, c, d):
        self.V[v]=(x,y,c,d)
        with open ("test1.dat", "a") as salida:
    ...
    def archivo(self):
        with open("testtarea3.plot", "w") as archivo:
            print("set term eps", file=archivo)
            print("set output 'test1.eps'", file=archivo)
            ...
            print("plot 'test1.dat' using 1:2:3:4 with points pt var lc palette var", file=archivo)
